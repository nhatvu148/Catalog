...
namespace Catalog.UnitTests
{
    public class ItemsControllerTests
    {
        ...
        [Fact]
        public async Task CreateItemAsync_WithItemToCreate_ReturnsCreatedItem() //UnitOfWork_StateUnderTest_ExpectedBehavior()
        {
            // Arrange
        ...
        [Fact]
        public async Task UpdateItemAsync_WithExistingItem_ReturnsNoContent() //UnitOfWork_StateUnderTest_ExpectedBehavior()
        {
            // Arrange
        ...
        [Fact]
        public async Task DeleteItemAsync_WithExistingItem_ReturnsNoContent() //UnitOfWork_StateUnderTest_ExpectedBehavior()
        {
            // Arrange
            Item existingItem = CreateRandomItem();
            repositoryStub.Setup(repo => repo.GetItemAsync(It.IsAny<Guid>()))
